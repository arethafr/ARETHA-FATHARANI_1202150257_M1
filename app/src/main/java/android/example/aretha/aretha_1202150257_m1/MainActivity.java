package android.example.aretha.aretha_1202150257_m1;

import android.content.Intent;
import android.example.aretha.aretha_1202150257_m1.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Judul = (TextView) findViewById(R.id.Judul1);
    ...
    public void btn_eatboss (View view) {
        Intent btn_eatbus = new Intent(this, MainActivity2);
    ...
    public void btn_abnormal (View view) {
        Intent btn_abnormal  = new Intent(this, activity_main_2);
